...
Vendored verbatim from the tutti-agent-skills `tutti-workspace-app-factory`
skill (scripts/validate_tutti_app_package.py) so this repository — and its CI —
can validate the built package without the skill being installed. Keep it in
sync with the upstream factory validator when the package contract changes.
"""
